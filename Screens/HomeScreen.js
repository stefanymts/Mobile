...
btnSync: { backgroundColor: '#11551a', margin: 20, padding: 15, borderRadius: 12, alignItems: 'center' },
...
card: { width: '100%', height: 160, borderRadius: 15, overflow: 'hidden', backgroundColor: '#3db136' },
image: { width: '100%', height: '100%', resizeMode: 'cover' },
cardOverlay: { position: 'absolute', bottom: 0, width: '100%', backgroundColor: '#11551aaa', padding: 8 },
recipeTitle: { color: '#f2f5f7', fontWeight: 'bold', textAlign: 'center', fontSize: 12 },
deleteBtn: { position: 'absolute', top: -10, right: -10, backgroundColor: '#f2f5f7', width: 28, height: 28, borderRadius: 14, justifyContent: 'center', alignItems: 'center', zIndex: 99 },
deleteText: { color: '#11551a', fontWeight: 'bold' }
});
