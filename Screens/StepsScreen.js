...
title: { fontSize: 24, fontWeight: 'bold', color: '#11551a', marginBottom: 20 },
videoButton: { backgroundColor: '#11551a', padding: 15, borderRadius: 12, marginBottom: 20 },
...
categoryBadge: {
backgroundColor: '#3db136', // Verde para diferenciar dos ingredientes
paddingVertical: 6,
...
categoryBadgeText: { color: '#f2f5f7', fontWeight: 'bold', textTransform: 'uppercase', fontSize: 14 },
...
marginBottom: 15,
borderLeftWidth: 6,
borderLeftColor: '#11551a'
},
stepNum: { fontSize: 12, fontWeight: 'bold', color: '#11551a', marginBottom: 4 },
stepText: { fontSize: 17, color: '#f2f5f7', lineHeight: 24 },

homeButton: { backgroundColor: '#11551a', padding: 20, borderRadius: 15, marginTop: 20, marginBottom: 40 },
